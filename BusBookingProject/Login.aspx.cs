...
namespace BusBookingProject
{
    ...
    {
        private static readonly SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["OnlineBusBookingConnectionString"].ToString());
        #region Global Variable
        SqlConnection connString = sqlConnection;
        #endregion
